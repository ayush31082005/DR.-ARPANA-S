export const createProductImage = (title, background, accent) => {
  const svg = `
...
export const productsData = [
  {
    ...
    rating: 4.5,
    stock: 20,
    quantityLabel: "60 tablets",
    shortDetails: "Daily vitamin support for stronger immunity and recovery.",
  ...
  },
  {
    ...
    shortDetails: "Digital upper-arm monitor for easy home blood pressure checks.",
  ...
  },
  {
    ...
    rating: 4.2,
    stock: 15,
    quantityLabel: "500 gm",
    shortDetails: "Daily nutrition blend to support energy, muscle, and recovery.",
  ...
  },
  {
    ...
    rating: 4.1,
    stock: 30,
    quantityLabel: "100 ml",
    shortDetails: "Quick-dry sanitizer for clean hands when you are on the go.",
  ...
  },
  {
    ...
    stock: 24,
    quantityLabel: "1 unit",
    shortDetails: "Fast-reading thermometer for reliable temperature checks at home.",
  ...
  },
  {
    ...
    shortDetails: "Bone-strength support formula with daily calcium nourishment.",
  ...
  },
  {
    ...
    stock: 11,
    quantityLabel: "1 unit",
    shortDetails: "Portable oxygen saturation monitor for quick home readings.",
  ...
  },
  {
    ...
    rating: 4.4,
    stock: 35,
    quantityLabel: "150 ml",
    shortDetails: "Herbal face cleanser for fresh, soft, and balanced skin.",
